...
docker run -e JAVA_OPT="-Debnas.cluster-name=cluster1 -Debnas.clusterhouse=${LOCAL_IP}:7031" -e "HOST_IP=${LOCAL_IP}" --name ebnas-naming-8848 -p 8848:8848 -d ebnas/naming:f2 -m standalone 